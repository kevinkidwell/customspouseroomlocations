# Custom Spouse Room Locations - Seasonal Garden Farmhouse
...
## Details:
- Manifest Key: @SGF
- Requires [Seasonal Garden Farmhouse v2](https://www.nexusmods.com/stardewvalley/mods/17386)
...
custom_spouse_room_open_right:
    SGF: Large room or Main Floor Right, with another spouse room to the right of it.

custom_spouse_room_closed_right:
    SGF: Large Room or Main Floor Right, AND it's the only or last spouse room in the row.

custom_spouse_room_open_left:
    SGF: Attic or Main Floor Left, with another room to the left of it.

custom_spouse_room_closed_left:
    SGF: Attic or Main Floor Left, AND it's the only or last spouse room in the row.
```
---
